...
function addThreat() {
  ...
  el.innerHTML = `
      ...
      <div class="field">
        <label>Frameworks <span class="req">*</span></label>
        <select required name="" id="h${id}-framework">
          <option value="" selected>Select a framework</option>
      ...
      <div class="field">
          ...
          <select  required name="" id="h${id}-how" onchange="updateTitle(${id})">
      ...
      <div class="field">
        ...
        <select required name="" id="h${id}-further">
          <option value="" selected>Select a control measure</option>
          ...
          <option value="Regular Backups">Regular Backups</option>
          <option value="Access Control Policy">Access Control Policy</option>
          <option value="Anti-virus Software">Anti-virus Software</option>
        </select>
      </div>
